...
void MbrRcds::load(CSVrcds& csvRcds) {
...
void MbrRcds::maxLng(String& s, int& max) {int lng = s.length();  if (lng > max) max = lng;}



void MbrRcds::compare() {
MbrIter      iter(*this);
int          i;
TrainingRcd* trn;
String       fcc;
...
void MbrRcds::dsplyData(TrainingRcd* rcd, String& status, double count) {
